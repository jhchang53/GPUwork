/*
	cgsera.cpp - complicated test - float version
*/
#include <stdio.h>
#include <math.h>
#include "CGcyl.h"
...
*/
  ...
  float xmin0[] = {-35.0, -35.0, 18.5};
  float xmax0[] = { 35.0,  35.0, 76.0};
  cg[0]->RPP(xmin0,xmax0);
  cg[1] = new CGrpp();
  // cg[1]->RPP( -8.5 ,     8.5 ,   -6.25,     6.25,     74.0,     75.72);
  float xmin1[] = { -8.5 ,  -6.25, 74.0};
  float xmax1[] = {  8.5 ,   6.25, 75.72};
  cg[1]->RPP(xmin1,xmax1);
  cg[2] = new CGrpp();
  // cg[2]->RPP( -25.0,     25.0,   -25.0,     25.0,     61.5,     73.0);
  float xmin2[] = {-25.0, -25.0, 61.5};
  float xmax2[] = { 25.0,  25.0, 73.0};
  cg[2]->RPP(xmin2,xmax2);
  cg[3] = new CGrpp();
  // cg[3]->RPP( -24.0,     24.0,   -24.0,     24.0,     50.0,     55.0);
  float xmin3[] = {-24.0, -24.0, 50.0};
  float xmax3[] = { 24.0,  24.0, 55.0};
  cg[3]->RPP(xmin3,xmax3);
  cg[4] = new CGrpp();
  // cg[4]->RPP( -34.0,     34.0,   -34.0,     34.0,     23.5,     41.5);
  float xmin4[] = {-34.0, -34.0, 23.5};
  float xmax4[] = { 34.0,  34.0, 41.5};
  cg[4]->RPP(xmin4,xmax4);
  cg[5] = new CGrpp();
  // cg[5]->RPP( -25.0,     25.0,   -25.0,     25.0,     18.5,     22.7);
  float xmin5[] = {-25.0, -25.0, 18.5};
  float xmax5[] = { 25.0,  25.0, 22.7};
  cg[5]->RPP(xmin5,xmax5);
  cg[6] = new CGrpp();
  // cg[6]->RPP( -35.1,     35.1,   -35.1,     35.1,      0.0,     18.5);
  float xmin6[] = {-35.1, -35.1, 0.0};
  float xmax6[] = { 35.1,  35.1, 18.5};
  ...
  for(int ntry=0; ntry < nran; ntry++) {
    ...
    for(int ngo=0; ngo < 1000; ngo++) {
      ...
      // if(cgnext >= 0) {
        ...
        printf("%.4e  %.3f %.3f %.3f  ",dist, p[0],p[1],p[2]);
        printf("%.3f %.3f %.3f", w[0]*dist,w[1]*dist,w[2]*dist);
